...
def gen_dot_vis_idea_tree_png(seminal_pid):
    ...
    DOT_VIS_THUMBNAIL_PATH = '../idea_tree_thumbnail/'
    ...
    if not os.path.exists(DOT_VIS_THUMBNAIL_PATH):
        os.makedirs(DOT_VIS_THUMBNAIL_PATH)
    gml2png(DOT_VIS_GML_FILE_PATH+str(seminal_pid)+'/'+str(year)+'.gml', DOT_VIS_THUMBNAIL_PATH+str(seminal_pid)+'.jpg', label_flag=False, bg_type=0, edge_weight=25)
